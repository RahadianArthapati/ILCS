 ...
 */
public class AssignTicketFragment extends Fragment implements TapView, IHttpResponse {
    ...
    private void setData() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                ArrayList<TicketObject> arrDatas = VectorModel.getInstance().getListAssignTicketObjects();
                if (arrDatas != null) {
                    data.clear();

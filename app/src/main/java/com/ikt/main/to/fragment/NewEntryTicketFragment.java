...
/**
 * Created by tunggul.jati 27/10/2017
 */
public class NewEntryTicketFragment extends Fragment implements TapView, IHttpResponse {
    ...
    private void setData() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                ArrayList<TicketObject> arrDatas = VectorModel.getInstance().getListEntryTicketObjects();
                if (arrDatas != null) {
                    data.clear();
    ...
    private void getTickets() {
        ArrayList<TicketObject> ticketObjects = VectorModel.getInstance().getListEntryTicketObjects();

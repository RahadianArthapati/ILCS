...
import com.ikt.main.to.adapter.ViewStatusTicketDetailAdapter;
...
public class ViewStatusTicketDetailActivity extends BaseActivity2 implements TapView,IHttpResponse {
    ...
    private ViewStatusTicketDetailAdapter mAdapter;
    private int pos = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_status_ticket_detail);
        ...
        mAdapter = new ViewStatusTicketDetailAdapter(this, data);
